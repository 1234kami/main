...
SECRET_KEY = 'django-insecure-la9ct6%lh*&6vxvw-39oiq*wt8ml-l!qist6dejr-at-nl7l+9'
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # Проверьте, что этот middleware включен
